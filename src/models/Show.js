...
const ShowSchema = new mongoose.Schema({
  ...
  firstAirDate: { type: String, default: "0000-00-00" },
  lastAirDate: { type: String, default: "0000-00-00" },
...
ShowSchema.pre('save', function (next, done) {
  const document = this;
  this.constructor.findOne({ id: this.id }).then(function (show) {
    if (show) {
      var err = new Error('Show exists');
      // Add show
      err.show = show;
      return;
    } else {
